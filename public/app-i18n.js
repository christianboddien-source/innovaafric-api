...
(function () {
  const D = {
    ...
    // párrafos informativos completos (un nodo cada uno)
    'Cuando un cliente hace un pedido a tu tienda, aparece en Comandas. Prepáralo y pulsa "Lista — avisar riders": los riders disponibles de tu ciudad la verán al instante y uno la aceptará para entregarla.': { fr: 'Quand un client passe une commande à ta boutique, elle apparaît dans Commandes. Prépare-la et appuie sur « Prête — prévenir les livreurs » : les livreurs disponibles de ta ville la verront aussitôt et l’un d’eux l’acceptera pour la livrer.', en: 'When a client places an order to your shop, it appears in Orders. Prepare it and tap "Ready — notify riders": available riders in your city will see it instantly and one will accept it to deliver.' },
    'Ponte Disponible, abre Comandas y acepta los pedidos de los comercios cercanos. Tu pago por entrega se acredita según las reglas de XenderDelivery. El mapa en vivo muestra tu posición y la de otros riders y representantes de tu ciudad.': { fr: 'Mets-toi Disponible, ouvre Commandes et accepte les commandes des commerces proches. Ton paiement par livraison est crédité selon les règles de XenderDelivery. La carte en direct montre ta position et celle des autres livreurs et représentants de ta ville.', en: 'Set yourself Available, open Orders and accept orders from nearby shops. Your delivery pay is credited per XenderDelivery rules. The live map shows your position and that of other riders and representatives in your city.' },
    'Autorizas Circulares en los barrios de tu zona y ganas el 50% del ahorro de cada compra de unidades que ellas hacen. Recibes los depósitos de efectivo de tus circulares y los entregas a InnovaAFRIC.': { fr: 'Tu autorises des Circulaires dans les quartiers de ta zone et tu gagnes 50% de l’économie de chaque achat d’unités qu’elles font. Tu reçois les dépôts en espèces de tes circulaires et tu les remets à InnovaAFRIC.', en: 'You authorize Circulars in the neighborhoods of your area and earn 50% of the savings from every unit purchase they make. You receive the cash deposits from your circulars and hand them to InnovaAFRIC.' },
    'Deposita el dinero cobrado a tus clientes directamente en una sucursal de InnovaAFRIC o en la oficina de tu representante. Al solicitar unidades recibirás la referencia de transferencia.': { fr: 'Dépose l’argent encaissé auprès de tes clients directement dans une agence InnovaAFRIC ou au bureau de ton représentant. En demandant des unités tu recevras la référence de virement.', en: 'Deposit the cash collected from your clients directly at an InnovaAFRIC branch or your representative’s office. When you request units you will receive the transfer reference.' },
    'Tras solicitar, deposita el importe a pagar en una sucursal de InnovaAFRIC o en la oficina de tu representante, indicando la referencia que te daremos. Cuando InnovaAFRIC confirme el pago, las unidades se acreditarán a tu cuenta.': { fr: 'Après la demande, dépose le montant à payer dans une agence InnovaAFRIC ou au bureau de ton représentant, en indiquant la référence que nous te donnerons. Quand InnovaAFRIC confirmera le paiement, les unités seront créditées sur ton compte.', en: 'After requesting, deposit the amount due at an InnovaAFRIC branch or your representative’s office, stating the reference we give you. When InnovaAFRIC confirms the payment, the units will be credited to your account.' },
    'Al trasladar unidades a tu wallet se retienen los impuestos según la configuración de tu país (o la retención estándar de InnovaAFRIC). El neto queda disponible en tu cuenta XenderMoney para retirar o gastar.': { fr: 'En transférant des unités vers ton wallet, les impôts sont retenus selon la configuration de ton pays (ou la retenue standard d’InnovaAFRIC). Le net reste disponible sur ton compte XenderMoney pour retirer ou dépenser.', en: 'When you move units to your wallet, taxes are withheld according to your country’s configuration (or InnovaAFRIC’s standard withholding). The net amount stays available in your XenderMoney account to withdraw or spend.' },
    'El cierre de caja muestra todo el efectivo cobrado en el día — es la cantidad que debes entregar en la sucursal de InnovaAFRIC o a tu representante. Imprime el PDF y entrégalo firmado junto con el dinero.': { fr: 'La clôture de caisse montre tout l’argent encaissé dans la journée — c’est le montant que tu dois remettre à l’agence InnovaAFRIC ou à ton représentant. Imprime le PDF et remets-le signé avec l’argent.', en: 'The cash closing shows all the cash collected during the day — it’s the amount you must hand to the InnovaAFRIC branch or your representative. Print the PDF and hand it signed along with the money.' }
  };
